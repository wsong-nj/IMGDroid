...
public class TestAnalysis {
	...
	//ystem.out.println("");Detecting Local Image Decoding without Permission
		...
		System.out.println("-------Detecting Image Decoding Without Resizing -------");
		  withoutResizing re =new withoutResizing();
		  w=re.isResizing(classes,name);
		System.out.println("Detecting Image Passing by Intent");  
		  analysisIntent ai = new analysisIntent(cg,classes);
		  a=ai.anaIntent(classes,name);
		  
	   System.out.println("Detecting Repeated Decoding Without Caching");
		repeatLoading rp = new repeatLoading();
	    r=rp.loopDecoding(classes,name);
		
			
		
	
     System.out.println("Detecting Image Decoding in UI Thread");
       decodingInUI ui = new decodingInUI();  
        u=ui.isDecodingInUI(classes,name);
