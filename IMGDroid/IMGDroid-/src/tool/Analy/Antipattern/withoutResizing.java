...
//  	}
	...
	public int isResizing(List<SootClass> classes,String n) {
...
//													System.out.println("unit" +unit);
									...
									if(methodName.equals("setImageURI")
									  ...
									  if(!sm.method().getName().equals("setImageURI")) {
										...
										WR++;
                                              ...
                                              AWR=isResizeByAndroid(df,unit,methodName,sm,n);
	...
	public int isResizeByAndroid(MHGDominatorsFinder<Unit>  df,Unit unit,String methodName,SootMethod sm,String n) {
...
//			        
		...
		if(n.contains("a p")||n.contains("doc")) {
	        return 0;
